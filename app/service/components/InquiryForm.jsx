                    ...
                    <div className='mb-8'>
                        ...
                        <form onSubmit={handleSubmit} className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                            <div className='flex flex-col gap-2'>
                                ...
                                <input name="name" required type="text" placeholder="Rosendo Cuyasen" className='p-3 bg-transparent border border-gray-400 rounded-md outline-none focus:border-pink-500 transition-colors' />
                            </div>
                            <div className='flex flex-col gap-2'>
                            ...
                            <div className='flex flex-col gap-2'>
                                ...
                                <select name="projectType" className='p-3 bg-transparent border border-gray-400 rounded-md outline-none focus:border-pink-500 dark:bg-gray-900'>
                            ...
                            <div className='flex flex-col gap-2'>
                                ...
                                <select name="budget" className='p-3 bg-transparent border border-gray-400 rounded-md outline-none focus:border-pink-500 dark:bg-gray-900'>
                                    <option>$2k – $5k</option>
                            ...
                            <div className='flex flex-col gap-2 md:col-span-2'>
                                ...
                                <input name="timeline" required type="text" placeholder="When do you need to launch?" className='p-3 bg-transparent border border-gray-400 rounded-md outline-none focus:border-pink-500 transition-colors' />
                            </div>
                            <div className='flex flex-col gap-2 md:col-span-2'>
                                <label className='text-sm font-semibold'>Project Details</label>
                                <textarea name="details" required rows="4" placeholder="Briefly describe your project goals..." className='p-3 bg-transparent border border-gray-400 rounded-md outline-none focus:border-pink-500 transition-colors'></textarea>
                            </div>
                            ...
                            <div className='w-full md:w-auto mt-4'>
                                <button 
                                    ...
                                    type="submit" 
                                    className={`px-10 py-4 border rounded-full border-gray-500 flex items-center gap-2 duration-500 font-semibold ${isSubmitting ? 'opacity-50 cursor-not-allowed' : 'hover:-translate-y-1 dark:bg-pink-900 bg-pink-200'}`}
                                >
                                    {isSubmitting ? "Sending..." : `Send Inquiry for ${selectedService}`}
                                    <Image src={assets.right_arrow} className='w-4' alt=''/>
                                </button>
                                {result && <p className={`mt-4 text-sm ${result.includes('Thank') ? 'text-green-500' : 'text-red-500'}`}>{result}</p>}
                            </div>
                        </form>
                    </div>
                </div>
