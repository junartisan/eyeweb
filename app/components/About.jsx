...
const About = () => { 
  ...
  return (
    ...
    <div className='flex w-full flex-col lg:flex-row'>
        <div className='w-90 sm:w-80 rounded-3xl max-w-none p-2 mt-0 pt-0'>
        ...
        <div className='flex-1'>
            <p className='text-lg mb-10 max-w-2xl font-Ovo text-gray-800 dark:text-white'>"We are professional app developers with over a decade of experience. Our team has collaborated with numerous organizations, contributing to their growth and success through innovative web applications." </p>
            <ul className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl'>
                {infoList.map(({icon, iconDark, title, description}, index)=>(
                    <li className='border-[.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-light-hover hover:-translate-y-1 duration-500 hover:shadow-2xs dark:border-white dark:hover:shadow-white dark:hover:bg-dark-hover/50'  key={index}>
                        ...
                        <p className='text-gray-600 text-lg dark:text-white/80'>{description}</p>
                    </li>
